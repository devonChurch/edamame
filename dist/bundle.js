...
/***/ function(module, exports, __webpack_require__) {
	...
	var Hero = (function () {
	    ...
	    _createClass(Hero, [{
	        ...
	        key: 'tabChangeListener',
	        value: function tabChangeListener() {
	            var _this2 = this;
	        ...
	        key: 'createGraphInstances',
	        value: function createGraphInstances() {
	        ...
	        key: 'destroyGraphInstances',
	        value: function destroyGraphInstances() {
	        ...
	        key: 'createRelevance',
	        value: function createRelevance() {
