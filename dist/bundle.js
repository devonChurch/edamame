...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(7); /* global TweenMax, TimelineMax, Linear */
	__webpack_require__(9); /* global Snap, mina */
	...
	var Counter = (function () {
	    ...
	    _createClass(Counter, [{
	        ...
	        key: 'obscureCounter',
	        value: function obscureCounter() {
	
	            var timeline = new TimelineMax();
	            var speed = this.Graph.speed / 1000;
	            var duration = 0.5;
	            var delay = speed - duration;
	
	            timeline.stop().delay(delay).to([this.$point, this.$number], duration, { opacity: 0 }).to([this.$point, this.$number], duration, { opacity: 1 }, '+=' + (speed + delay));
	        ...
	        key: 'positionCounter',
	        value: function positionCounter() {
	...
	var Graph = (function () {
	    ...
	    _createClass(Graph, [{
	        ...
	        value: function animateSequence() {
	            ...
	            this.Spline.svg.animate({ path: this.Spline.createSpline() }, this.speed, mina.linear, function () {
	                _this2.animateCallback();
	            });
	        }
	    }, {
	        key: 'animateCallback',
